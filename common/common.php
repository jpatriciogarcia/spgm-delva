...
$mail->SMTPAuth 		= LOGIN;
$mail->Username 		= "spgm@delva.cl"; 
$mail->Password 		= "delva2007";
...
$mail->AddBCC("erico.jara@delva.cl");
$mail->AddBCC("jpatriciogarcia@gmail.com");
...
$pop3 				= new pop3_class;
$pop3->hostname		= "192.168.0.11";      		/* POP 3 server host name                      */
$pop3->port			= 110;                         	/* POP 3 server host port                      */
$user				= "spgm@delva.cl";     /* Authentication user name                    */
$password			= "delva2007";                    	/* Authentication password                     */
$pop3->realm		= "";                         	/* Authentication realm or domain              */
$pop3->workstation	= "";                   		/* Workstation for NTLM authentication         */
$apop				= 0;                            /* Use APOP authentication                     */
$pop3->authentication_mechanism	= "DIGEST-MD5";			/* SASL authentication mechanism               */
...
define( "_EMPRESA_"				, "Isolux" );
define( "_SIGLA_PROVEEDOR_"		, "ISO");
define( "_INTEGRADOR_"			, "Movistar" );
...
$codigos_error = array(
					...
					998 => "Mail Enviado a "._INTEGRADOR_,
					...
					9	=> "El folio ya existe",
					10	=> "Mensaje se ha procesado con anterioridad"
					);
...
/*
Formatos de los codigos de errores

ID_ACCION	COD_ACCION	NAME_ACCION									DESCRIPCION	ID_FORMATO
 5			ERR			Valor Proveniente de Proveedor es NULO	
 4			ERR			Folio ATIX no Existe
 */
$_ERRORES	= array( 
