...
/*----------------------------------------------------------------
						Conexion ADODB
----------------------------------------------------------------*/
require("/var/www/spgm/common/adodb/adodb.inc.php");
require( "/var/www/spgm/common/adodb/tohtml.inc.php");
...
--------------------------------------------------------------*/
require( "/var/www/spgm/common/phpmailer/class.phpmailer.php" );
...
$mail->Timeout			= 30;
$mail->SetLanguage( "es","/var/www/spgm/common/phpmailer/language/" );
$mail->AddAddress( "atix@telefonicamoviles.cl" );
$mail->AddBCC( "jgarcia@nsoft.cl" );
/*-------------------------------------------------------------
--------------------------------------------------------------*/
...
*/
require("/var/www/spgm/common/pop3.class.php" );
...
require("/var/www/spgm/common/db_functions.php");
