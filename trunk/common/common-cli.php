...
$pop3->authentication_mechanism	= "LOGIN";			/* SASL authentication mechanism               */
...
$codigos_error = array(
					...
					2	=> "Error Aplicaci�n en Sistema del Proveedor",
					3	=> "Error Aplicaci�n en Sistema "._INTEGRADOR_,
					4	=> "Folio ATIX no Existe",
					5	=> "Valor Proveniente de Proveedor es NULO",
					6	=> "Subject fuera de formato",
					7	=> "Acci�n No permitida, Falta acci�n previa",
...
$_ERRORES	= array(
				...
				"2" 	=> array("ERR", "Error Aplicaci�n en Sistema del Proveedor"),
				"3" 	=> array("ERR", "Error Aplicaci�n en Sistema ATIX Movistar"),
